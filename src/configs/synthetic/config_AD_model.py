...
param_list_AD_OrnsteinUhlenbeckWithSeason_3 = get_parameter_array(param_dict=param_dict_AD_OrnsteinUhlenbeckWithSeason_3)
param_list_AD_OrnsteinUhlenbeckWithSeason += param_list_AD_OrnsteinUhlenbeckWithSeason_3
...
param_dict_AD_modules += param_dict_AD_modules_noise
param_dict_AD_modules += param_dict_AD_modules_cutoff
param_dict_AD_modules += param_dict_AD_modules_diffusion
param_dict_AD_modules += param_dict_AD_modules_spike
