...
# ------------------------------------------------------------------------------
# training on alpha diversity metric

microbial_models_path_alpha_div = "{}saved_models_microbial_alpha_div/".format(data_path)
param_list_microbial_alpha_div = []
...
for add_pred, which_loss in [
        ...
        param_dict_microbial_sig_rnn_alpha_div = {
                ...
                'std_factor': [std_factor],
                'plot_moments': [plot_moments],
                'saved_models_path': [microbial_models_path_alpha_div],
                'use_cond_exp': [True],
                'input_current_t': [input_current_t],
                'periodic_current_t': [True],
                'scale_dt': [scale_dt],
        ...
        param_list_microbial_alpha_div += get_parameter_array(
                param_dict=param_dict_microbial_sig_rnn_alpha_div)

for add_pred, which_loss in [
        [["var"], "variance_bis2"],
]:
        param_dict_microbial_sig_rnn_alpha_div = {
                'dataset': ['microbial_div_alpha_faith_pd_3',
                            'microbial_div_alpha_faith_pd_4',
                            'microbial_div_alpha_faith_pd_5'],
                'dataset_split': ["no_abx",],
                'epochs': [epochs],
                'batch_size': [batch_size],
                'save_every': [save_every],
...
overview_dict_microbial_alpha_div = dict(
    ids_from=1, ids_to=len(param_list_microbial_alpha_div),
    path=microbial_models_path_alpha_div,
    params_extract_desc=('dataset', 'dataset_split',
                         'ode_nn', 'enc_nn', 'readout_nn',
                         'dropout_rate', 'hidden_size', 'batch_size',
                         'pre-train',
...
# ------------------------------------------------------------------------------
# training on novel alpha diversity metric

microbial_models_path_novel_alpha_div = "{}saved_models_microbial_novel_alpha_div/".format(data_path)
param_list_microbial_novel_alpha_div = []
...
for add_pred, which_loss in [
        ...
        param_dict_microbial_sig_rnn_novel_alpha_div = {
                'dataset': ['microbial_novel_alpha_faith_pd',
                            'microbial_novel_alpha_faith_pd_w_geo',],
                'dataset_split': ["no_abx",],
                'epochs': [epochs],
                'batch_size': [batch_size],
                'save_every': [save_every],
...
for add_pred, which_loss in [
        ...
        param_dict_microbial_sig_rnn_novel_alpha_div = {
                ...
                'use_observation_as_input': [
                    0.5, "lambda x: np.random.random(1) < max(0.5, 1-x/6000)",
                ],
...
# joint training: alpha div & relative abundance enteropathogens
for add_pred, which_loss in [
        [["var"], "variance_bis2"],
]:
        param_dict_microbial_sig_rnn_novel_alpha_div = {
                'dataset': ['microbial_novel_alpha_faith_pd_entero_family',
                            'microbial_novel_alpha_faith_pd_entero_genus'],
                'dataset_split': ["no_abx",],
                'epochs': [epochs],
                'batch_size': [batch_size],
                'save_every': [save_every],
        ...
        param_list_microbial_joint = get_parameter_array(
                param_dict=param_dict_microbial_sig_rnn_novel_alpha_div)
        param_list_microbial_novel_alpha_div += param_list_microbial_joint
...
for add_pred, which_loss in [
        ...
        param_dict_microbial_sig_rnn_novel_alpha_div = {
                'dataset': ['microbial_novel_alpha_faith_pd_entero_genus_scaled'],
                'dataset_split': ["no_abx",],
                'epochs': [epochs],
                'batch_size': [batch_size],
                'save_every': [save_every],
        ...
        param_list_microbial_joint1 = get_parameter_array(
                param_dict=param_dict_microbial_sig_rnn_novel_alpha_div)
        param_list_microbial_novel_alpha_div += param_list_microbial_joint1

# use dynamic features as input
param_list_microbial_novel_alpha_div_dyn_ft = []
for add_pred, which_loss in [
        [["var"], "variance_bis2"],
]:
        param_dict_microbial_sig_rnn_novel_alpha_div = {
...
for add_pred, which_loss in [
        ...
        param_dict_microbial_sig_rnn_novel_alpha_div = {
            'dataset': ['microbial_rel_abd_enteropathogens_genus_w_geo',],
            'dataset_split': ["no_abx",],
            'epochs': [epochs],
            'batch_size': [batch_size],
            'save_every': [save_every],
...
overview_dict_microbial_novel_alpha_div = dict(
    ...
    path=microbial_models_path_novel_alpha_div,
    params_extract_desc=('dataset', 'dataset_split',
                         'ode_nn', 'enc_nn', 'readout_nn',
                         'dropout_rate', 'hidden_size', 'batch_size',
                         'pre-train',
