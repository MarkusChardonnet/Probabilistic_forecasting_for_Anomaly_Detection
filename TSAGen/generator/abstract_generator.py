...
class AbstractSeasonGenerator():
    def __init__(self, cycle_num, amplitude, cycle_len, drift_a=0, drift_f=0, forking_depth=6, depth=10):
        self.cycle_list = []
        self.label_list = []
        ...
        self.cycle_generator = RMDF(depth=depth)
    ...
    def _gen(self):
        ...
        for drift_amp, length_d in zip(self.drift_a_for_every_cycle, self.drift_f_for_every_cycle):
            ...
            season = drift_amp*amplitude*self.cycle_generator.gen(self.forking_depth, length)
    ...
    def save_anchor(self,path):
        self.cycle_generator.save_anchor(path)

    def load_anchor(self,path):
        self.cycle_generator.load_anchor(path)