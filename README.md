...
novel alpha diversity metric datasets:
```shell
python run.py --params=param_list_microbial_novel_alpha_div --NB_JOBS=64 --NB_CPUS=1 --SEND=True --USE_GPU=False --first_id=1 --get_overview=overview_dict_microbial_alpha_div
```
